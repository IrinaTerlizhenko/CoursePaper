...
public class SweepLine {
        ...
        while (!events.isEmpty()) {
            ...
            if (e.tp == +1) {
                ...
                if (nxt != null && nxt.id != seg.get(id).id && !hasEqualEndPoints(nxt, seg.get(id)) && intersect(nxt, seg.get(id))) {
                    ...
                    double x_intersect = x_intersection_point(nxt, seg.get(id));
                ...
                if (prv != null && prv.id != seg.get(id).id && !hasEqualEndPoints(prv, seg.get(id)) && intersect(prv, seg.get(id))) {
                    ...
                    double x_intersect = x_intersection_point(prv, seg.get(id));
                    Event evt = new Event(x_intersect, 0, 0);
                ...
                if (nxt != null && prv != null && nxt.id != prv.id && !hasEqualEndPoints(nxt, prv) && intersect(nxt, prv)) {
                    ...
                    double x_intersect = x_intersection_point(prv, nxt);
                    Event evt = new Event(x_intersect, 0, 0);
                    evt.id1 = nxt.id;
                    evt.id2 = prv.id;
                    events.add(evt);
                ...
                if (nxt != null && nxt.id != seg.get(id2).id && !hasEqualEndPoints(nxt, seg.get(id2)) && intersect(nxt, seg.get(id2))) {
                    ...
                    double x_intersect = x_intersection_point(nxt, seg.get(id2));
                    Event evt = new Event(x_intersect, 0, 0);
                    evt.id1 = nxt.id;
                ...
                if (prv != null && prv.id != seg.get(id1).id && !hasEqualEndPoints(prv, seg.get(id1)) && intersect(prv, seg.get(id1))) {
                    ...
                    double x_intersect = x_intersection_point(prv, seg.get(id1));
                    Event evt = new Event(x_intersect, 0, 0);
                    evt.id1 = prv.id;
                ...
                double x_intersect = x_intersection_point(s1, s2);
                Point p1 = new Point();
    ...
    private static double x_intersection_point(Segment a, Segment b) {
        Point p1 = a.p,
                p2 = a.q,
                p3 = b.p,
                p4 = b.q;
